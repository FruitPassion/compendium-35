...
class TechniqueAstucieuse(db.Model):
    ...
    source = db.relationship(
        "Source", primaryjoin="TechniqueAstucieuse.id_source == Source.id_source"
    )
    ...
    def get_all():
        ...
        """
        return (
            db.session.query(TechniqueAstucieuse, Source)
            .select_from(TechniqueAstucieuse)
            .join(Source)
            .order_by(TechniqueAstucieuse.nom)
            .all()
        )
