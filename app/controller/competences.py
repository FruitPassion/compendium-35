...
def index():
    ...
    return render_template("competences/index.html", competences=competences, synergie=synergie)
...
def competence(nom):
    ...
    return render_template("competences/competence.html", competence=competence, synergies=synergies, dons_requis=dons_requis, dons_augmentes=dons_augmentes, synergies_inverse=synergies_inverse)
...
def techniques_astucieuses():
    ...
    return render_template("competences/techniques_astucieuses.html", techniques=techniques, condtions=condtions)