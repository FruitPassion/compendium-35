...
VALUES ('Manuel du Joueur', 'D&D 3.5', '', TRUE),
 ('Manuel du Joueur II', 'D&D 3.5', '', TRUE),
 ('Guide du Maitre', 'D&D 3.5', '', TRUE),
 ('Guide du Maitre II', 'D&D 3.5', '', TRUE),
 ('Manuel des Monstres', 'D&D 3.5', '', TRUE),
 ('Manuel des Monstres 3', 'D&D 3.5', '', TRUE),
 ('Manuel des Monstres 4', 'D&D 3.5', '', TRUE),
 ('Manuel des Monstres 5', 'D&D 3.5', '', TRUE),
 ('Grand Manuel des Psioniques', 'D&D 3.5', '', TRUE),
 ('Miniatures Handbook', 'D&D 3.5', '', TRUE),
 ('Chapitres Sacrés', 'D&D 3.5', '', TRUE),
 ('Fiend Folio', 'D&D 3.5', '', TRUE),
 ('Codex Martial', 'D&D 3.5', '', TRUE),
 ('Codex Divin', 'D&D 3.5', '', TRUE),
 ('Codex Profane', 'D&D 3.5', '', TRUE),
 ('Codex Aventureux', 'D&D 3.5', '', TRUE),
 ('Complete Psionnic', 'D&D 3.5', '', TRUE),
 ('Complete Champion', 'D&D 3.5', '', TRUE),
 ('Complete Mage', 'D&D 3.5', '', TRUE),
 ('Complete Scoundrel', 'D&D 3.5', '', TRUE),
 ('Draconomicon', 'D&D 3.5', '', TRUE),
 ('Dragon Magic', 'D&D 3.5', '', TRUE),
 ('Le Guide du Voyageur Planaire', 'D&D 3.5', '', TRUE),
 ('FrostBurn', 'D&D 3.5', '', TRUE),
 ('SandStorm', 'D&D 3.5', '', TRUE),
 ('StormWrack', 'D&D 3.5', '', TRUE),
 ('CityScape', 'D&D 3.5', '', TRUE),
 ('Les Arcanes Exhumées', 'D&D 3.5', '', TRUE),
 ('Libris Mortis', 'D&D 3.5', '', TRUE),
 ('Races de la Pierre', 'D&D 3.5', '', TRUE),
 ('Races of the Wild', 'D&D 3.5', '', TRUE),
 ('Races of Destiny', 'D&D 3.5', '', TRUE),
 ('Races of Dragon', 'D&D 3.5', '', TRUE),
 ('Lord of Madness', 'D&D 3.5', '', TRUE),
 ('Heroes of Horror', 'D&D 3.5', '', TRUE),
 ('Heroes of Battle', 'D&D 3.5', '', TRUE),
 ('Guide des personnages Monstrueux', 'D&D 3.5', '', TRUE),
 ('Compendium Arcanique', 'D&D 3.5', '', TRUE),
 ('Magic Item Compendium', 'D&D 3.5', '', TRUE),
 ('Dungeonscape', 'D&D 3.5', '', TRUE),
 ('Tome of Battle, The Book of Nnine Swords', 'D&D 3.5', '', TRUE),
 ('Magic of Incarnum', 'D&D 3.5', '', TRUE),
 ('Receuil de Magie', 'D&D 3.5', '', TRUE),
 ('Weapons of Legacy', 'D&D 3.5', '', TRUE),
 ('Fiendish Codex I - Hordes of the Abyss', 'D&D 3.5', '', TRUE),
 ('Fiendish Codex II - Tyrants of the Nine Hells', 'D&D 3.5', '', TRUE),
 ('Elder Evils', 'D&D 3.5', '', TRUE),
 ('Drow of the Underdark', 'D&D 3.5', '', TRUE),
 ('Exemplars of Evil', 'D&D 3.5', '', TRUE),
 ('Manuel des monstres 2', 'D&D 3.0', '', TRUE),
 ('Dieux et Demi-Dieux', 'D&D 3.0', '', TRUE),
 ('Les gardiens de la Foi', 'D&D 3.0', '', TRUE),
 ("D'Ombre et de Lumière", 'D&D 3.0', '', TRUE),
 ("Par l'Encre et le Sang", 'D&D 3.0', '', TRUE),
 ('Manuel des Psionniques', 'D&D 3.0', '', TRUE),
 ('Campagnes Légendaires', 'D&D 3.0', '', TRUE),
 ('Chapitres Interdits', 'D&D 3.0', '', TRUE),
 ('Manuel des Plans', 'D&D 3.0', '', TRUE),
 ('Arms and Equipement', 'D&D 3.0', '', TRUE),
 ('GhostWalk', 'D&D 3.0', '', TRUE),
 ("Hero Builder's Guildebook", 'D&D 3.0', '', TRUE),
 ('Manuel du constructeur de Donjon', 'D&D 3.0', '', TRUE),
 ('Ennemies and Allies', 'D&D 3.0', '', TRUE),
 ('DragonLance - Univers', 'DragonLance', '', TRUE),
 ('Eberron - Univers', 'Livre de Eberron', '', TRUE),
 ('Races of Eberron', 'Livre de Eberron', '', TRUE),
 ("Player's Guide to Eberron", 'Livre de Eberron', '', TRUE),
 ('Reliques et Rituels', 'Terres Balafrées', '', TRUE),
 ("Guide de l'Orient", 'Legend of Five Rings', '', TRUE),
 ('Manuel des Joueurs de Faerûn', 'Royaumes Oubliés', '', TRUE),
 ('Dogmes et Panthéons', 'Royaumes Oubliés', '', TRUE),
 ('Races de Faerûn', 'Royaumes Oubliés', '', TRUE),
 ('Magie de Faerûn', 'Royaumes Oubliés', '', TRUE),
 ('Monstres de Faerûn', 'Royaumes Oubliés', '', TRUE),
 ('Les Seigneurs des Ténèbres', 'Royaumes Oubliés', '', TRUE),
 ('Champions of Ruin', 'Royaumes Oubliés', '', TRUE),
 ('Champions of Valor', 'Royaumes Oubliés', '', TRUE),
 ("Marche d'Argent", 'Royaumes Oubliés', '', TRUE),
 ('Outre-Terre', 'Royaumes Oubliés', '', TRUE),
 ('Inaccessible Orient', 'Royaumes Oubliés', '', TRUE),
 ('Le Sud Etincellant', 'Royaumes Oubliés', '', TRUE),
 ('Lost Empires of Faerûn', 'Royaumes Oubliés', '', TRUE),
 ('Cité des Splendeurs : Eauprofonde', 'Royaumes Oubliés', '', TRUE),
 ('Royaumes Serpents', 'Royaumes Oubliés', '', TRUE),
 ('Dragons of Faerûn', 'Royaumes Oubliés', '', TRUE),
 ('Power of Faerûn', 'Royaumes Oubliés', '', TRUE),
 ('Recueil de magie', 'D&D 3.5', '', TRUE),
 ('Reliques et Rituels','Sword and Sorcery', '', TRUE),
 ('Gemmaline', 'Gemmaline', '', TRUE),
 ('Dragon Magazine', 'D&D 3.5', '', TRUE),
 ('Dungeon Magazine', 'D&D 3.5', '', TRUE),
 ("Book of Hallowed Might",'D&D 3.5', '', TRUE),
("Book of Words",'D&D 3.5', '', TRUE),
("City of Stormreach",'D&D 3.5', '', TRUE),
("Cité des Splendeurs - Eauprofonde",'D&D 3.5', '', TRUE),
("Compendium des révisions",'D&D 3.5', '', TRUE),
("Descent of Shadows",'D&D 3.5', '', TRUE),
("Domaine profane : Démons 9",'D&D 3.5', '', TRUE),
("Dragonmarked",'D&D 3.5', '', TRUE),
("Dragons of Eberron",'D&D 3.5', '', TRUE),
("Expedition to Undermountain",'D&D 3.5', '', TRUE),
("Expedition to the Demonweb Pits",'D&D 3.5', '', TRUE),
("Explorer’s Handbook",'D&D 3.5', '', TRUE),
("Faith of Eberron",'D&D 3.5', '', TRUE),
("Five Nations",'D&D 3.5', '', TRUE),
("Forge of War",'D&D 3.5', '', TRUE),
("Guide de l'orient Battle",'D&D 3.5', '', TRUE),
("Guide de l'orient Horror",'D&D 3.5', '', TRUE),
("Horrors of the Abyss",'D&D 3.5', '', TRUE),
("Le Divin et Le Déchu",'D&D 3.5', '', TRUE),
("Le Sud Etincelant",'D&D 3.5', '', TRUE),
("Les Maîtres de la Folie",'D&D 3.5', '', TRUE),
("Magic of Eberron",'D&D 3.5', '', TRUE),
("Planescape Campaign Setting",'D&D 3.5', '', TRUE),
("Player’s Guide to Eberron",'D&D 3.5', '', TRUE),
("Races of the Dragon",'D&D 3.5', '', TRUE),
("Ravenloft - Gazetter vol V",'D&D 3.5', '', TRUE),
("Ravenloft - Van Richten's Arsenal",'D&D 3.5', '', TRUE),
("Ravenloft- Legacy of the Blood",'D&D 3.5', '', TRUE),
("Royaumes Oubliés",'D&D 3.5', '', TRUE),
("Scénario - Anauroch the Empire of Shade",'D&D 3.5', '', TRUE),
("Scénario - Le Bastion des Âmes Damnées",'D&D 3.5', '', TRUE),
("Scénario - Le Cercle de Pierre",'D&D 3.5', '', TRUE),
("Scénario - Le Maître de la Forteresse deFer",'D&D 3.5', '', TRUE),
("Scénario - Legend of the Silver Skeleton,Stormwrack",'D&D 3.5', '', TRUE),
("Scénario - Les Ombres de la DernièreGuerre",'D&D 3.5', '', TRUE),
("Scénario- Anauroch the Empire of Shade",'D&D 3.5', '', TRUE),
("Secrets of Sarlona",'D&D 3.5', '', TRUE),
("Secrets of Xen’Drik",'D&D 3.5', '', TRUE),
("Seigneurs des Ténèbres",'D&D 3.5', '', TRUE),
("Sharn - la Cité des Tours",'D&D 3.5', '', TRUE),
("The Dread Codex",'D&D 3.5', '', TRUE),
("Wizards of the Coast Web Enhancements",'D&D 3.5', '', TRUE);
##
